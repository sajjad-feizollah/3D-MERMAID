% -_-_-_-_-_-_-_-_-_-_-_-_-_-_- MATLAB_NORDIC -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-
%
% Description: 
% -----------
% 
% NORDIC denoising adapted from NIFTI_NORDIC.m of NORDIC denosing available
% at: github.com/SteenMoeller/NORDIC_Raw
%
% Inputs:   im: complex image including all volumes.
% ------    ARG: parameters for denoising.
% 
% Outputs:  denoised: denoised image.
% -------
%       
% Article: 
% -------
%	Moeller et al., 2021 (https://doi.org/10.1016/j.neuroimage.2020.117539)
% -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-

function  denoised = MATLAB_NORDIC(im,ARG)
% fMRI
